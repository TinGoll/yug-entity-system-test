...
component.setComponentDescription('Геометрия') // Делаем описание на русском
...
console.log('------------------Снова восстанавливаем объект------------------------')
console.log(component.setComponent(component.build()).get());
